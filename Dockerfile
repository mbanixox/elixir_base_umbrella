...
# Copy child app mix files for dependency resolution
COPY apps/elixir_base/mix.exs apps/elixir_base/
COPY apps/elixir_base_web/mix.exs apps/elixir_base_web/
...
# Copy source code
COPY apps/elixir_base/lib apps/elixir_base/lib
COPY apps/elixir_base/priv apps/elixir_base/priv
COPY apps/elixir_base_web/lib apps/elixir_base_web/lib
COPY apps/elixir_base_web/priv apps/elixir_base_web/priv

RUN mix compile

# Copy assets separately to maximise layer caching
COPY apps/elixir_base_web/assets apps/elixir_base_web/assets
...
RUN mix release elixir_base_web
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/elixir_base_web ./
